...
class PrestaShopMCPServer {
    ...
    async callPrestaShopAPI(resource, method = 'GET', data) {
        ...
        try {
            ...
            if (axios.isAxiosError(error)) {
                throw new McpError(ErrorCode.InternalError, `PrestaShop API error22: ${error.response?.status} - ${error.response?.data || error.message}`);
            }
            throw error;
        }
    }
